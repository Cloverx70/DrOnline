        ...
        <motion.div whileHover={{ scale: 1.03 }}>
          <Card className="rounded-2xl shadow-md">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-semibold">Instant Emergency Call</h3>
              <p className="mt-2 text-muted-foreground">
                Trigger an emergency request with one tap to immediately notify
                nearby doctors or emergency responders.
              </p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <motion.div whileHover={{ scale: 1.03 }}>
          <Card className="rounded-2xl shadow-md">
            <CardContent className="p-6">
              ...
              <p className="mt-2 text-muted-foreground">
                We guide you to the nearest suitable hospital or clinic based on
        ...
        <motion.div whileHover={{ scale: 1.03 }}>
          <Card className="rounded-2xl shadow-md">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-semibold">Critical Case Handling</h3>
              <p className="mt-2 text-muted-foreground">
                Severe cases are prioritized and escalated immediately to ensure
